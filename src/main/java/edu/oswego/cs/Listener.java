...
//
                ...
                if (p.getOpcode() == PacketOpcode.PARTICIPANT_ACK) {
                    SceneController1.participantACK = (ParticipantACK) p;
                } else if (p.getOpcode() == PacketOpcode.getOpcode(4)) {
                    System.out.println("GREG: " + Arrays.toString(p.getBytes()));
                    SceneController1.participantData = (ParticipantData) p;
                }
